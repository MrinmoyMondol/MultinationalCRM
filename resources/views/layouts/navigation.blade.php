<!-- Topbar Start -->
        <header class="navbar-header">
            <div class="page-container topbar-menu">
                <div class="gap-2 d-flex align-items-center">
                    ...
                    <button class="p-0 border-0 sidenav-toggle-btn btn" id="toggle_btn2">
                <i class="ti ti-arrow-bar-to-right"></i>
                    ...
                    <div class="me-auto d-flex align-items-center header-search d-lg-flex d-none">
                        ...
                        <div class="input-icon position-relative me-2">
                            ...
                            <span class="p-0 input-icon-addon d-inline-flex header-search-icon"><i class="ti ti-command"></i></span>
                        </div>
                        <!-- /Search -->
                    </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="header-item d-none d-sm-flex">
                        <div class="dropdown me-2">
                            ...
                            <div class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-md">

                                <!-- Item-->
                                <a href="contacts.html" class="dropdown-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <span class="mb-1 d-flex fw-semibold text-dark">Contacts</span>
                                ...
                                <a href="pipeline.html" class="dropdown-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <span class="mb-1 d-flex fw-semibold text-dark">Pipeline</span>
                                ...
                                <a href="activities.html" class="dropdown-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <span class="mb-1 d-flex fw-semibold text-dark">Activities</span>
                                ...
                                <a href="analytics.html" class="dropdown-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <span class="mb-1 d-flex fw-semibold text-dark">Analytics</span>
                    ...
                    <div class="header-item">
                        <div class="dropdown me-2">
                            ...
                            <button class="topbar-link btn dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" data-bs-offset="0,24" type="button" aria-haspopup="false" aria-expanded="false">
                        <i class="ti ti-bell-check fs-16 animate-ring"></i>
                        <span class="badge rounded-pill">10</span>
                    </button>

                            <div class="p-0 dropdown-menu dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                                ...
                                <div class="notification-body position-relative z-2 rounded-0" data-simplebar>
                                    ...
                                    <!-- Item-->
                                    <div class="py-3 dropdown-item notification-item text-wrap border-bottom" id="notification-1">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-2 position-relative">
                                                <img src="{{ asset('assets/img/users/user-01.jpg') }}" class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="gap-2 notification-action d-flex align-items-center float-end">
                                                        ...
                                                        <button class="p-0 btn rounded-circle" data-dismissible="#notification-1">
                                                    <i class="ti ti-x"></i>
                                                </button>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- Item-->
                                    <div class="py-3 dropdown-item notification-item text-wrap border-bottom" id="notification-2">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-2 position-relative">
                                                <img src="{{ asset('assets/img/users/user-12.jpg') }}" class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="gap-2 notification-action d-flex align-items-center float-end">
                                                        <a href="javascript:void(0);" class="notification-read rounded-circle bg-danger" data-bs-toggle="tooltip" title="" data-bs-original-title="Make as Read" aria-label="Make as Read"></a>
                                                        <button class="p-0 btn rounded-circle" data-dismissible="#notification-2">
                                                    <i class="ti ti-x"></i>
                                                </button>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- Item-->
                                    <div class="py-3 dropdown-item notification-item text-wrap border-bottom" id="notification-3">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-2 position-relative">
                                                <img src="{{ asset('assets/img/profiles/avatar-12.jpg') }}" class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="gap-2 notification-action d-flex align-items-center float-end">
                                                        <a href="javascript:void(0);" class="notification-read rounded-circle bg-danger" data-bs-toggle="tooltip" title="" data-bs-original-title="Make as Read" aria-label="Make as Read"></a>
                                                        <button class="p-0 btn rounded-circle" data-dismissible="#notification-3">
                                                    <i class="ti ti-x"></i>
                                                </button>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- Item-->
                                    <div class="py-3 dropdown-item notification-item text-wrap" id="notification-4">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-2 position-relative">
                                                <img src="{{ asset('assets/img/profiles/avatar-08.jpg') }}" class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="gap-2 notification-action d-flex align-items-center float-end">
                                                        <a href="javascript:void(0);" class="notification-read rounded-circle bg-danger" data-bs-toggle="tooltip" title="" data-bs-original-title="Make as Read" aria-label="Make as Read"></a>
                                                        <button class="p-0 btn rounded-circle" data-dismissible="#notification-4">
                                                    <i class="ti ti-x"></i>
                                                </button>
                                                    </div>
                                                </div>
                                ...
                                <div class="p-2 text-center rounded-bottom border-top">
                                    <a href="notifications.html" class="mb-0 text-center text-decoration-underline fs-14">
                    ...
                    <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative" data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                            ...
                            <span class="online text-success"><i class="bg-white border border-white ti ti-circle-filled d-flex rounded-circle border-1"></i></span>
                        </a>
                        <div class="p-2 dropdown-menu dropdown-menu-end dropdown-menu-md">

                            <div class="p-2 mb-2 d-flex align-items-center bg-light rounded-3">
                                <img src="{{ asset('assets/img/users/user-40.jpg') }}" class="rounded-circle" width="42" height="42" alt="">
                                <div class="ms-2">
                                    <p class="mb-0 fw-medium text-dark">Katherine Brooks</p>
                            ...
                            <a href="profile-settings.html" class="dropdown-item">
                                <i class="align-middle ti ti-user-circle me-1"></i>
                                <span class="align-middle">Profile Settings</span>
                            </a>

                            <!-- item -->
                            <div class="mb-0 form-check form-switch form-check-reverse d-flex align-items-center justify-content-between dropdown-item">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <i class="align-middle ti ti-help-circle me-1"></i>
                                <span class="align-middle">Help & Support</span>
                            </a>

                            <!-- Item-->
                            <a href="profile-settings.html" class="dropdown-item">
                                <i class="align-middle ti ti-settings me-1"></i>
                            ...
                            <div class="pt-2 mt-2 border-top">
                                <a href="{{ route('logout') }}" class="dropdown-item text-danger" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="align-middle ti ti-logout me-1 fs-17"></i>
            ...
            <div class="modal-dialog modal-lg">
                <div class="bg-transparent modal-content">
                    <div class="mb-0 shadow-none card">
                        <div class="flex-row px-3 py-2 d-flex align-items-center" id="search-top">
                            <i class="ti ti-search fs-22"></i>
                            <input type="search" class="border-0 form-control" placeholder="Search">
                            <button type="button" class="p-0 btn" data-bs-dismiss="modal" aria-label="Close"><i class="ti ti-x fs-22"></i></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-logo">
                ...
                <button class="p-0 border-0 sidenav-toggle-btn btn active" id="toggle_btn">
            ...
            <div class="sidebar-inner" data-simplebar>
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <ul>
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="/" class="active">Deals Dashboard</a></li>
                                        <li><a href="leads-dashboard.html" class="">Leads Dashboard</a></li>
                                        <li><a href="project-dashboard.html" class="">Project Dashboard</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class=""><i class="ti ti-brand-airtable"></i><span>Applications</span><span class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="chat.html" class="">Chat</a></li>
                                        <li class="submenu submenu-two">
                                            <a href="javascript:void(0);" class="">Call<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                                                <li><a href="video-call.html" class="">Video Call</a></li>
                                                <li><a href="audio-call.html" class="">Audio Call</a></li>
                                        ...
                                        <li><a href="kanban-view.html" class="">Kanban</a></li>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="company.html" class="">Companies</a></li>
                                        <li><a href="subscription.html" class="">Subscriptions</a></li>
                                        <li><a href="packages.html" class="">Packages</a></li>
                                        <li><a href="domain.html" class="">Domain</a></li>
                                        <li><a href="purchase-transaction.html" class="">Purchase Transaction</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="#" class="">
                                    ...
                                    <ul>
                                        <li><a href="layout-mini.html" class="">Mini</a></li>
                                        <li><a href="layout-hoverview.html" class="">Hover View</a></li>
                                        <li><a href="layout-hidden.html" class="">Hidden</a></li>
                                        <li><a href="layout-fullwidth.html" class="">Full Width</a></li>
                                        <li><a href="layout-rtl.html" class="">RTL</a></li>
                                        <li><a href="layout-dark.html" class="">Dark</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a class="" href="lead-reports.html">Lead Reports</a></li>
                                        <li><a class="" href="deal-reports.html">Deal Reports</a></li>
                                        <li><a class="" href="contact-reports.html">Contact Reports</a></li>
                                        <li><a class="" href="company-reports.html">Company Reports</a></li>
                                        <li><a class="" href="project-reports.html">Project Reports</a></li>
                                        <li><a class="" href="task-reports.html">Task Reports</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li class=""><a href="sources.html"><i class="ti ti-artboard"></i><span>Sources</span></a></li>
                                <li class=""><a href="lost-reason.html"><i class="ti ti-message-exclamation"></i><span>Lost Reason</span></a></li>
                                <li class=""><a href="contact-stage.html"><i class="ti ti-steam"></i><span>Contact Stage</span></a></li>
                                <li class=""><a href="industry.html"><i class="ti ti-building-factory"></i><span>Industry</span></a></li>
                                <li class=""><a href="calls.html"><i class="ti ti-phone-check"></i><span>Calls</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-title"><span>User Management</span></li>
                        <li>
                            <ul>
                                <li class=""><a href="manage-users.html"><i class="ti ti-users"></i><span>Manage Users</span></a></li>
                                <li class=""><a href="roles-permissions.html"><i class="ti ti-user-shield"></i><span>Roles & Permissions</span></a></li>
                                <li class=""><a href="delete-request.html"><i class="ti ti-flag-question"></i><span>Delete Request</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a class="" href="membership-plans.html">Membership Plans</a></li>
                                        <li><a class="" href="membership-addons.html">Membership Addons</a></li>
                                        <li><a class="" href="membership-transactions.html">Transactions</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li class=""><a href="pages.html"><i class="ti ti-page-break"></i><span>Pages</span></a></li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                        <i class="ti ti-brand-blogger"></i><span>Blog</span><span class="menu-arrow"></span>
                                    </a>
                                    <ul>
                                        <li><a href="blogs.html" class="">All Blogs</a></li>
                                        <li><a href="blog-categories.html" class="">Blog Categories</a></li>
                                        <li><a href="blog-comments.html" class="">Blog Comments</a></li>
                                        <li><a href="blog-tags.html" class="">Blog Tags</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="" href="states.html">States</a></li>
                                        <li><a class="" href="cities.html">Cities</a></li>
                                    </ul>
                                </li>
                                <li class=""><a href="testimonials.html"><i class="ti ti-quote"></i><span>Testimonials</span></a></li>
                                <li class=""><a href="faq.html"><i class="ti ti-question-mark"></i><span>FAQ</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-title"><span>Support</span></li>
                        <li>
                            <ul>
                                <li class=""><a href="contact-messages.html"><i class="ti ti-message-check"></i><span>Contact Messages</span></a></li>
                                <li class=""><a href="tickets.html"><i class="ti ti-ticket"></i><span>Tickets</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="profile-settings.html" class="">Profile</a></li>
                                        <li><a href="security-settings.html" class="">Security</a></li>
                                        <li><a href="notifications-settings.html" class="">Notifications</a></li>
                                        <li><a href="connected-apps.html" class="">Connected Apps</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                    ...
                                    <ul>
                                        <li><a href="company-settings.html" class="">Company Settings</a></li>
                                        <li><a href="localization-settings.html" class="">Localization</a></li>
                                        <li><a href="prefixes-settings.html" class="">Prefixes</a></li>
                                        <li><a href="preference-settings.html" class="">Preference</a></li>
                                        <li><a href="appearance-settings.html" class="">Appearance</a></li>
                                        <li><a href="language-settings.html" class="">Language</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                    ...
                                    <ul>
                                        <li><a href="invoice-settings.html" class="">Invoice Settings</a></li>
                                        <li><a href="printers-settings.html" class="">Printers</a></li>
                                        <li><a href="custom-fields-settings.html" class="">Custom Fields</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                    ...
                                    <ul>
                                        <li><a href="email-settings.html" class="">Email Settings</a></li>
                                        <li><a href="sms-gateways.html" class="">SMS Gateways</a></li>
                                        <li><a href="gdpr-cookies.html" class="">GDPR Cookies</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                    ...
                                    <ul>
                                        <li><a href="payment-gateways.html" class="">Payment Gateways</a></li>
                                        <li><a href="bank-accounts.html" class="">Bank Accounts</a></li>
                                        <li><a href="tax-rates.html" class="">Tax Rates</a></li>
                                        <li><a href="currencies.html" class="">Currencies</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="clear-cache.html" class="">Clear Cache</a></li>
                                        <li><a href="storage.html" class="">Storage</a></li>
                                        <li><a href="cronjob.html" class="">Cronjob</a></li>
                                        <li><a href="ban-ip-address.html" class="">Ban IP Address</a></li>
                                        <li><a href="system-backup.html" class="">System Backup</a></li>
                                        <li><a href="database-backup.html" class="">Database Backup</a></li>
                                        <li><a href="system-update.html" class="">System Update</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li class=""><a href="blank-page.html"><i class="ti ti-file"></i><span>Blank Page</span></a></li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="ui-dragula.html" class="">Dragula</a></li>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="icon-typicon.html" class="">Typicons Icons</a></li>
                                        <li><a href="icon-flag.html" class="">Flag Icons</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class=""><i class="ti ti-map-star"></i><span>Maps</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                    <ul>
                                        <li>
                                            <a href="maps-vector.html" class="">Vector</a>
                                        </li>
                                        <li>
                                            <a href="maps-leaflet.html" class="">Leaflet</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
